...
class Robot(event.Dispatcher):
    ...
    * A Behaviors object, starting and ending robot behaviors such as looking around
    ...
    # @NOTE execute_custom_behavior
    # /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/cozmoclad/clad/types/behaviorSystem/behaviorTypes.py
    #AcknowledgeFace = 0
    #AcknowledgeObject = 1
    #Bouncer = 2
    #BuildPyramid = 3
    ...
    def execute_custom_behavior(self, id):
        msg = _clad_to_engine_iface.ExecuteBehaviorByID(id)
        self.conn.send_msg(msg)
